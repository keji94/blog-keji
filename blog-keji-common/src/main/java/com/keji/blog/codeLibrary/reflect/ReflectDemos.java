package com.keji.blog.codeLibrary.reflect;
...
public class ReflectDemos {
    ...
    public static void demo1() throws Exception{
        ...
        // 3: 反射中的方法
        Class c3 = Class.forName("com.keji.blog.codeLibrary.reflect.Person");// 包名.类名
    ...
    public static void demo2() throws Exception{
        //获取Class对象
        Class c = Class.forName("com.keji.blog.codeLibrary.reflect.Person");//包名.类名
