...
_extend(KDialog, KWidget, {
	init : function(options) {
		...
		var contentDiv = K('<div class="ke-dialog-backstage"></div>').appendTo(self.div);
		if (_IE && _V < 7) {
	...
	showLoading : function(msg) {
		...
		self.loading = K('<div class="ke-dialog-loading"><div class="ke-inline-block ke-dialog-loading-backstage" style="margin-top:' + Math.round(body.height() / 3) + 'px;">' + msg + '</div></div>')
		...
		var dialog = self.createDialog({
			...
			yesBtn : {
				...
				click : function(e) {
					...
					var url = [checkbox[0].checked ? self.pluginsPath + 'baidumap/demo1.jsp' : 'http://api.map.baidu.com/staticimage',
...
KindEditor.plugin('map', function(K) {
	...
	self.clickToolbar(name, function() {
		...
		var iframeHtml = ['<!doctype html><html><head>',
			'<meta name="viewport" backstage="initial-scale=1.0, user-scalable=no" />',
			'<style>',
			'	html { height: 100% }',
