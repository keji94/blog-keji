...
<link rel="stylesheet" type="text/css"
	href="<c:url value='../css'/>/base.css" media="all">
<link rel="stylesheet" type="text/css"
	href="<c:url value='../css'/>/plist20131112.css" media="all">
<link rel="stylesheet" type="text/css"
	href="<c:url value='../css'/>/list-page-20141009.css" media="all">
<link rel="stylesheet" type="text/css"
	href="<c:url value='../css'/>/pop_compare.css" media="all">
<link rel="shortcut icon" type="image/ico"
	href="http://list.jd.com/favicon.ico">
<script type="text/javascript"
	src="<c:url value='../js'/>/jquery-1.2.6.pack.js"></script>
...
<div id="o-header-2013">
	<div class="w" id="header-2013">
		<div id="logo-2013" class="ld"><a href="http://www.jd.com/" hidefocus="true"><b></b><img src="<c:url value='../images'/>/logo-201305.png" width="270" height="60" alt="京东"></a></div>
		<!--logo end-->
		<div id="search-2013">
...
<div class="w">
    ...
    <div id="footer-2013">
        ...
        <div class="authentication"><a rel="nofollow" target="_blank" href="http://www.hd315.gov.cn/beian/view.asp?bianhao=010202007080200026"><img width="108" height="40" alt="经营性网站备案中心" src="<c:url value='../images'/>/108_40_zZOKnl.gif" class="err-product"></a>
